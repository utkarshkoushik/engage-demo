    ...
    return (
      ...
      >
        <div className="chat__item__content">
          ...
          {this.props.type == 'img' && <img onClick={this.setOpen} src={"https://www.localhost:9000" + this.props.img} style={{ width: 200, height: 200, objectFit: 'contain', cursor: 'pointer' }}></img>}
